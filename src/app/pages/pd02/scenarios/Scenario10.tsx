...
const Scenario10 = () => {
  const scenario = PHISHING_QUIZ.find((s) => s.id === 'scn-10');
  ...
  const indicators = [
    'Solicitud directa de contraseña',
    'Uso de urgencia para presionar al usuario',
    'Remitente con dominio sospechoso',
    'Falta de proceso oficial de soporte',
    'Petición de información sensible por correo',
  ];
  ...
  const result = useMemo<ScenarioResult | null>(() => {
    ...
    if (selectedAnswer === 'A') {
      return {
        ...
        message:
          'Identificaste correctamente que el mensaje corresponde a un caso de ingeniería social para robo de credenciales.',
      };
    }
    ...
    return {
      ...
      message:
        'El mensaje no debe considerarse legítimo. Ningún equipo de soporte confiable solicita contraseñas por correo electrónico.',
    };
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-[#1a1a1a]/40 border border-[#d4a574]/20 p-5 space-y-2">
            <p className="text-sm font-mono text-[#d4a574]/80">
              <span className="text-[#cc6633]">Título:</span> Mensaje de soporte técnico solicitando contraseña
            </p>
            <p className="text-sm font-mono text-[#d4a574]/80">
              <span className="text-[#cc6633]">Tipo de vector:</span> Ingeniería social
            </p>
            <p className="text-sm font-mono text-[#d4a574]/80">
              <span className="text-[#cc6633]">Categoría:</span> Soporte técnico falso
            </p>
            <p className="text-sm font-mono text-[#d4a574]/80">
        ...
        <div className="mb-8">
          ...
          <div className="text-[#d4a574]/85 font-mono leading-relaxed bg-[#1a1a1a]/40 border border-[#d4a574]/20 p-5">
            Recibes un correo del área de soporte técnico indicando que hay un problema con tu cuenta
            y que necesitan tu contraseña para solucionarlo rápidamente.
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <SimulatedEmailCard
            from="Soporte TI <soporte@it-servicio-helpdesk.com>"
            subject="Problema con tu cuenta - Acción requerida"
            body={`Hola,

Hemos detectado un problema con tu cuenta que requiere atención inmediata.

Para poder resolverlo, necesitamos que nos proporciones tu usuario y contraseña a la brevedad posible.

Por favor responde a este correo con tus datos de acceso para continuar con la solución.

Gracias por tu colaboración.

Equipo de Soporte TI`}
            linkText="Responder mensaje"
            linkUrl="mailto:soporte@it-servicio-helpdesk.com"
        ...
        <div className="mb-10 bg-[#1a1a1a]/40 border border-[#d4a574]/20 p-5">
          ...
          >
            ...
            <div>
              <label
                htmlFor="question-10-justification"
                className="block text-sm font-mono text-[#d4a574] mb-2"
              >
                Justificación breve (opcional)
              </label>
              <textarea
                id="question-10-justification"
                name="question-10-justification"
                rows={4}
