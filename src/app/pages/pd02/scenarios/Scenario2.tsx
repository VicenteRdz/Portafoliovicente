...
const Scenario2 = () => {
  const scenario = PHISHING_QUIZ.find((s) => s.id === 'scn-02');
  ...
  const indicators = [
    ...
    'Acción inmediata a través de un enlace',
  ];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-[#1a1a1a]/40 border border-[#d4a574]/20 p-5 space-y-2">
            <p className="text-sm font-mono text-[#d4a574]/80">
              <span className="text-[#cc6633]">Título:</span> Cobro pendiente por entrega de paquete
            </p>
            <p className="text-sm font-mono text-[#d4a574]/80">
              <span className="text-[#cc6633]">Tipo de vector:</span> Correo phishing
            </p>
            <p className="text-sm font-mono text-[#d4a574]/80">
              <span className="text-[#cc6633]">Categoría:</span> Suplantación de servicio de paquetería
            </p>
            <p className="text-sm font-mono text-[#d4a574]/80">
        ...
        <div className="mb-8">
          ...
          <div className="text-[#d4a574]/85 font-mono leading-relaxed bg-[#1a1a1a]/40 border border-[#d4a574]/20 p-5">
            Recibes un correo aparentemente enviado por una empresa de paquetería. El mensaje indica
            que tu paquete no pudo ser entregado y que debes pagar una tarifa para reprogramar la entrega.
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <SimulatedEmailCard
            from="EnvíosExpress <notificaciones@envios-express-entregas.com>"
            subject="Entrega suspendida - Pago requerido para reprogramación"
            body={`Estimado cliente:

No fue posible completar la entrega de su paquete debido a un cargo pendiente de procesamiento.

Para reprogramar la entrega y evitar la devolución del envío, debe cubrir una tarifa de servicio de manera inmediata en el siguiente enlace.

Si no realiza el pago en las próximas 12 horas, su paquete será devuelto al remitente.

Atentamente,
Centro de Distribución
EnvíosExpress`}
            linkText="Pagar tarifa de entrega"
            linkUrl="http://envios-express-entregas.com/pago/reprogramacion"
        ...
        <div className="mb-10 bg-[#1a1a1a]/40 border border-[#d4a574]/20 p-5">
          ...
          >
            ...
            <div>
              <label
                htmlFor="question-2-justification"
                className="block text-sm font-mono text-[#d4a574] mb-2"
              >
                Justificación breve (opcional)
              </label>
              <textarea
                id="question-2-justification"
                name="question-2-justification"
                rows={4}
